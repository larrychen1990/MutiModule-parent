...
public class ConstantsUtil {
	 ...
	 */
	public static final String ADMIN_LOGIN_CONSTANTS = "admin_login_constants_";
	
	/**
	 * redis 方面，key的过期时间，一分钟
	 */
	public static final int EXPIRE_TIME_1_MINUTE = 1;
	
	/**
	 * redis 方面。key的过期时间，三十分钟
	 */
	public static final int EXPIRE_TIME_30_MINUTE = 30;
}
